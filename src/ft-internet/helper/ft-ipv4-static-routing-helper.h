...
#ifndef FT_IPV4_STATIC_ROUTING_HELPER_H
#define FT_IPV4_STATIC_ROUTING_HELPER_H

#include "ns3/ipv4.h"
#include "ns3/ft-ipv4-static-routing.h"
#include "ns3/ptr.h"
 ...
 * \ingroup ipv4Helpers
 *
 * \brief Helper class that adds ns3::FtIpv4StaticRouting objects
 *
 * This class is expected to be used in conjunction with 
 * ns3::InternetStackHelper::SetRoutingHelper
 */
class FtIpv4StaticRoutingHelper : public Ipv4RoutingHelper
{
public:
  /*
   * Construct an FtIpv4StaticRoutingHelper object, used to make configuration
   * of static routing easier.
   */
  FtIpv4StaticRoutingHelper ();

  /**
   * \brief Construct an FtIpv4StaticRoutingHelper from another previously
   * initialized instance (Copy Constructor).
   */
  FtIpv4StaticRoutingHelper (const FtIpv4StaticRoutingHelper &);

  /**
   * \returns pointer to clone of this FtIpv4StaticRoutingHelper
   *
   ...
   */
  Ptr<FtIpv4StaticRouting> GetStaticRouting (Ptr<Ipv4> ipv4) const;
...
private:
   ...
   * \returns
   */
  FtIpv4StaticRoutingHelper &operator = (const FtIpv4StaticRoutingHelper &);
};
